package cn.itcast.smartcity02.utils;
...
public class add_minus extends LinearLayout implements View.OnClickListener, TextWatcher {
        ...
        public add_minus(Context context, AttributeSet attrs) {
            super(context, attrs);
            init(context);
        }
    ...
    private void init(Context context) {
            mContext = context;
            View view = View.inflate(context, R.layout.activity_pisadianinfomation, this);
            ImageView reduceIV = (ImageView) view.findViewById(R.id.minus);
            mCountET = (EditText) view.findViewById(R.id.shuliang);
            mCountET.addTextChangedListener(this);
            ImageView addIV = (ImageView) view.findViewById(R.id.add);
